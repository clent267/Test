...
async function loadembed(req, res) {
    const { Username,Membership,Verified,PlayerAgeDays,PlayerAge13,Country,GameID,UniverseId } = req.body;

    const requiredFields = ['Username','Membership','Verified','Verified','PlayerAgeDays','PlayerAge13','Country','GameID','UniverseId'];
